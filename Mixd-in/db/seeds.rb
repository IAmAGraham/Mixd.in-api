...
Ingredient.create(name:'Whiskey', unit: 'ounces')
Ingredient.create(name:'Vodka', unit: 'ounces')
Ingredient.create(name:'Tequila', unit: 'ounces')
Ingredient.create(name:'Gin', unit: 'ounces')
Ingredient.create(name:'Rum', unit: 'ounces')
Ingredient.create(name:'Scotch', unit: 'ounces')
Ingredient.create(name:'Bourbon', unit: 'ounces')
Ingredient.create(name:'Cognac', unit: 'ounces')
Ingredient.create(name:'Sweet Vermouth', unit: 'ounces')
Ingredient.create(name:'Ginger Beer', unit: 'cups')
...
Ingredient.create(name:'Water', unit: 'ounces')
Ingredient.create(name:'Seltzer', unit: 'ounces')
Ingredient.create(name:'Soda', unit: 'ounces')
Ingredient.create(name:'Sour Mix', unit: 'ounces')
