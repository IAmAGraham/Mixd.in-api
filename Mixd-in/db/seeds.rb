...
Ingredient.create(name:'Whiskey', unit: '1/2 ounce')
Ingredient.create(name:'Vodka', unit: '1/2 ounce')
Ingredient.create(name:'Tequila', unit: '1/2 ounce')
Ingredient.create(name:'Gin', unit: '1/2 ounce')
Ingredient.create(name:'Rum', unit: '1/2 ounce')
Ingredient.create(name:'Scotch', unit: '1/2 ounce')
Ingredient.create(name:'Bourbon', unit: '1/2 ounce')
Ingredient.create(name:'Cognac', unit: '1/2 ounce')
Ingredient.create(name:'Sweet Vermouth', unit: '1/2 ounce')
Ingredient.create(name:'Ginger Beer', unit: '1/2 cup')
...
Ingredient.create(name:'Water', unit: '1/2 ounce')
Ingredient.create(name:'Seltzer', unit: '1/2 ounce')
Ingredient.create(name:'Soda', unit: '1/2 ounce')
Ingredient.create(name:'Sour Mix', unit: '1/2 ounce')
